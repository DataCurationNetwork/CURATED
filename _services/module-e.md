...
weight: 6
layout: service
description: Evaluate the results of the curation process, assessing the impact of data curation on the findability, accessibility, interoperability, and reusability of the deposit.
---
